...
4. Wake from phone. A signed one-time URL or a small PWA button that triggers Deploy without opening the full dashboard, so the concentrator can be started from anywhere, then used seconds later.
